...
Then next, under CUPButer should be "Condition Lab". Open it, and select "Import" from top right. It should open a file picker, navigate inside FoundryVTT's data folder to get the condition map from Ironclaw2E's system folder. (Default in Windows: %localappdata%/FoundryVTT/Data/systems/ironclaw2e/condition-maps)
